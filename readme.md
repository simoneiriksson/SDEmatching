## Simons Master's thesis project on Stochastich Differential Equation Matching
...
4) And activate the new python environment: ```source myenv/bin/activate```
5) Install the package into your actiuve environment: ```pip install -e .```
