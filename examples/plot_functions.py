...
def plot_marginal(sdeproblem, data, state_dim, axes=None, fig=None, true_states=None, true_states_ts=None, num_timesteps=30,
                  num_samples=100, max_num_data=10, device="cpu", timeseries_separate_plots=True):
    ...
    data_extended.shape  # num_timesteps, num_samples, num_data, series_length, statedim+1
    data_extended_flat = data_extended.reshape([num_timesteps* num_samples* num_data, series_length, state_dim+1])
